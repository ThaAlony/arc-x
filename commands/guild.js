exports.run = (client, message, args, command, account) => {
    ...
    if (!args[0]) {
        if (client.lingua == "it") return message.reply(" l'utilizzo corretto è " + client.config.prefix + command + " crea/info/modifica/invita/caccia/elimina")
    ...
    switch (args[0].toLowerCase()) {
        ...
        case "info":
            ...
            break;
        default:
            if (lingua == "it") return message.reply(" l'utilizzo corretto è " + client.config.prefix + command + " crea/info/modifica/invita/caccia/elimina")
            return message.reply(" the correct use is " + client.config.prefix + command + " create/info/modify/invite/kick/delete")
    }
